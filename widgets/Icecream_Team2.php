...
class Icecream_Team2 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Team 2', 'icecreamteam' );
    }
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        wp_register_style( 'icecream-team-css2', plugin_dir_url( __FILE__ ) . 'assets/css/icecream-team2.css' );
    }

    public function get_style_depends() {
        return [ 'icecream-team-css2' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->start_controls_section(
            'overlay_style_section', [
                'label' => esc_html__( 'Overlay', 'icecreamteam' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .image-overlay-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
			'overlay_backcolor',
			[
				'label' => esc_html__( 'Background color', 'icecreamteam' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .image-overlay-container' => 'background-color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selector' => '{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box h3.member-name',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box h3.member-name' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box h3.member-name' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box h3.member-name' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selector' => '{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .member-title',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .member-title' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .member-title' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .member-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .social-links li i' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .social-links li i:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .social-links li i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .icecream-simpleteam-box .social-links li:not(li:last-child)' => 'padding-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam2 .img-container .social-links ul' => 'justify-content: {{VALUE}};',
				],
			]
		);
    ...
    protected function render() {
        ...
        <div class="icecream-simpleteam2">
                ...
                <div class="img-container">
                    ...
                    <div class="image-overlay">
						<div class="image-overlay-container">
							<?php if( $get_name ): ?>
								<h3 class="member-name"><?php echo $get_name; ?></h3>
							<?php endif; ?>
							<?php if( $get_position ): ?>
								<div class="member-title"><?php echo $get_position; ?></div>
							<?php endif;?>

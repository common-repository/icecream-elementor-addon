...
class Icecream_Team1 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Team 1', 'icecreamteam' );
    }
    ...
    public function __construct( $data = [], $args = null ) {
        ...
        wp_register_style( 'icecream-team-css', plugin_dir_url( __FILE__ ) . 'assets/css/icecream-team.css' );
    }

    public function get_style_depends() {
        return [ 'icecream-team-css' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box:hover .img-container .overlay-color' => 'background-color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .img-container .overlay-color' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selector' => '{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box h3.member-name',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box h3.member-name' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box h3.member-name' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box h3.member-name' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selector' => '{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .member-title',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .member-title' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .member-title' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .member-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .social-links li i' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .social-links li i:hover' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .social-links li i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .social-links li:not(li:last-child)' => 'padding-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .icecream-simpleteam .icecream-simpleteam-box .social-links li:last-child' => 'padding-right: 0',
				],
			]
		);

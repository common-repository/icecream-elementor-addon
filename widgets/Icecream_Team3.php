...
class Icecream_Team3 extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Team 3', 'icecreamteam' );
    }
    ...
    function get_keywords() {
        return [ 'team', 'member', 'simple' ];
    }

    public function __construct( $data = [], $args = null ) {
        parent::__construct( $data, $args );
        wp_register_style( 'icecream-team-css3', plugin_dir_url( __FILE__ ) . 'assets/css/icecream-team3.css' );
    }

    public function get_style_depends() {
        return [ 'icecream-team-css3' ];
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
			'member_position',
			[
				'label' => esc_html__( 'Position', 'icecreamteam' ),
				'type' => \Elementor\Controls_Manager::TEXT,
        ...
        $this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Member description...', 'icecreamteam' ),
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .member-details' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'image_width',
			[
				'label' => esc_html__( 'Image width %', 'icecreamteam' ),
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .img-container' => 'width: {{SIZE}}%;',
				],
			]
		);
		...
		$this->add_control(
			'details_width',
			[
				'label' => esc_html__( 'Details width %', 'icecreamteam' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .member-details' => 'width: {{SIZE}}%;',
				],
			]
		);
        ...
        $this->add_control(
			'show_border',
			[
				'label' => esc_html__( 'Show border', 'icecreamteam' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'icecreamteam' ),
				'label_off' => esc_html__( 'Hide', 'icecreamteam' ),
				'return_value' => 'yes',
				'default' => 'no',
			]
		);
        ...
        $this->add_control(
			'box_border',
			[
				'label' => esc_html__( 'Border width', 'icecreamteam' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box' => 'border: {{SIZE}}{{UNIT}} solid;',
				],
                'condition' => [
                    'show_border' => 'yes'
                ]
        ...
        $this->add_responsive_control(
			'box_direction',
			[
				'label' => esc_html__( 'Direction', 'icecreamteam' ),
				...
				'options' => [
					...
					'column' => [
						'title' => esc_html__( 'Bottom', 'icecreamteam' ),
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box' => 'flex-direction: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_control(
			'border_color',
			[
				'label' => esc_html__( 'Border color', 'icecreamteam' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box' => 'border-color: {{VALUE}}',
				],
                'condition' => [
                    'show_border' => 'yes'
                ]
		...
		$this->add_control(
			'name_position',
			[
				'label' => esc_html__( 'Name position', 'icecreamteam' ),
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .img-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selector' => '{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box h3.member-name',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box h3.member-name' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box h3.member-name' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box h3.member-name' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selector' => '{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-title',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-title' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-title' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selector' => '{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-description',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-description' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-description' => 'text-align: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .member-description' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .social-links li i' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .social-links li i:hover' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .social-links ul' => 'justify-content: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .social-links li i' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .social-links li:not(li:last-child)' => 'padding-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_responsive_control(
			...
			[
                ...
                'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'selectors' => [
					'{{WRAPPER}} .icecream-simpleteam3 .icecream-simpleteam-box .social-links' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
    ...
    protected function render() {
        ...
        $get_description = esc_html( $settings['member_description'] );
        ...
        <div class="icecream-simpleteam3">
            <div class="icecream-simpleteam-box">
                ...
                <div class="member-details">
                    <?php if( $get_name ): ?>
                        <h3 class="member-name" style="order:<?php echo esc_html( $settings['name_position'] ); ?>"><?php echo $get_name; ?></h3>
                    <?php endif; ?>
                    <?php if( $get_position ): ?>
                        <div class="member-title" style="order:<?php echo esc_html( $settings['title_position'] ); ?>"><?php echo $get_position; ?></div>
                    <?php endif;?>
                    <?php if( $get_description ): ?>
                        <div class="member-description" style="order:<?php echo esc_html( $settings['description_position'] ); ?>"><?php echo $get_description; ?></div>
                    <?php endif;?>
